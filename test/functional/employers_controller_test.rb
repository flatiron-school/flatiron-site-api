...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { after_flatiron: @employer.after_flatiron, before_flatiron: @employer.before_flatiron, student: @employer.student, title: @employer.title }
    end
  ...
  test "should update employer" do
    put :update, id: @employer, employer: { after_flatiron: @employer.after_flatiron, before_flatiron: @employer.before_flatiron, student: @employer.student, title: @employer.title }
    assert_redirected_to employer_path(assigns(:employer))
  end
